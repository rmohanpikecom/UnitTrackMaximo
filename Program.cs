            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    try
                    {
                        ...
                        string EXPENDITUREDATE = dynamicObject.EXPENDITURE_DATE.ToString();
                        string PERSONNAME = dynamicObject.PERSON_NAME.ToString();
                        string PERSONNUMBER = dynamicObject.PERSON_NUMBER.ToString();
                        string HUMANRESOURCEASSIGNMENT = dynamicObject.HUMAN_RESOURCE_ASSIGNMENT.ToString();
                        string PROJECTNAME = dynamicObject.PROJECT_NAME.ToString();
                        string PROJECTNUMBER = dynamicObject.PROJECT_NUMBER.ToString();
                        string TASK_NAME = dynamicObject.TASK_NAME.ToString();
                        string TASK_NUMBER = dynamicObject.TASK_NUMBER.ToString();
                        string EXPENDITURETYPE = dynamicObject.EXPENDITURE_TYPE.ToString();
                        string EXPENDITUREORGANIZATION = dynamicObject.EXPENDITURE_ORGANIZATION.ToString();
                        string CONTRACTNUMBER = dynamicObject.CONTRACT_NUMBER.ToString();
                        string FUNDINGSOURCENUMBER = dynamicObject.FUNDING_SOURCE_NUMBER.ToString();
                        string NONLABORRESOURCE = dynamicObject.NONLABOR_RESOURCE.ToString();
                        string NONLABORRESOURCEORGANIZATION = dynamicObject.NONLABOR_RESOURCE_ORGANIZATION.ToString();
                        string QUANTITY = dynamicObject.QUANTITY.ToString();
                        string WORKTYPE = dynamicObject.WORK_TYPE.ToString();
